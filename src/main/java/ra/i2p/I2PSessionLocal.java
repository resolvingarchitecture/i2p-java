...
class I2PSessionLocal extends I2PSessionBase implements I2PSessionMuxedListener {

    private static final Logger LOG = Logger.getLogger(I2PSessionLocal.class.getName());
